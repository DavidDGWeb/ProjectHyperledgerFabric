...
public final class Constants {
    ...
    public static final String CHAINCODE_PRENDA_NAME = "chaincode";

    // Path to crypto materials.
    public static final Path CRYPTO_PATH_ORG1 = Paths.get("../test-network/organizations/peerOrganizations/org1.example.com");
